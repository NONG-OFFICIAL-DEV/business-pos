  ...
  <v-dialog :model-value="modelValue" @update:model-value="close" max-width="400">
    <v-card rounded="xl" class="pa-0 overflow-hidden">
      <div class="pa-4 bg-brown-darken-3 text-white d-flex align-center">
        ...
        <span class="text-h6 font-weight-bold">Apply Discount</span>
        <v-spacer />
      ...
      <v-card-text class="pa-5">
        ...
        <div class="section-label">Enter Value</div>
        <v-text-field
...
const presets = computed(() => {
  return discountType.ref === 'percentage' ? [5, 10, 15, 20, 50] : [1, 2, 5, 10]
})
