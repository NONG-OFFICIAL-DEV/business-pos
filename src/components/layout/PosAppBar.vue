...
<template>
  <v-app-bar elevation="0" class="header-glass px-4 border-b">
    ...
    <v-responsive max-width="500" class="flex-grow-1">
      <v-text-field
        :model-value="search"
    ...
    <v-spacer />
    <div v-if="!isCoffeeStore" class="d-none d-lg-flex align-center mr-6">
      ...
      <!-- <span class="text-caption font-weight-bold text-grey ml-2">
        Unpaid Orders
      </span> -->
    </div>
    <v-divider
    ...
    <div class="d-none d-lg-flex align-center mr-6">
